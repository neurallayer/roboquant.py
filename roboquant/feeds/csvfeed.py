...
class CSVFeed(InMemoryFeed):
    ...
    @classmethod
    def stooq_us_daily(cls, path: str | pathlib.Path, asset_filter: Callable[[Asset], bool] | None = None):
    ...
    @classmethod
    def stooq_us_intraday(cls, path: str | pathlib.Path, asset_filter: Callable[[Asset], bool] | None = None):
    ...
    @classmethod
    def yahoo(cls, path: str | pathlib.Path, frequency : str ="1d", asset_filter: Callable[[Asset], bool] | None = None):
