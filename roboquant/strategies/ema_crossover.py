...
class EMACrossover(Strategy):
    ...
    def __init__(
        self, fast_period: int = 13, slow_period: int = 26, smoothing: float = 2.0, price_type: str = "DEFAULT"
    ) -> None:
        super().__init__()
    ...
    class _Calculator:
        ...
        def __init__(self, momentum1: float, momentum2: float, price: float) -> None:
