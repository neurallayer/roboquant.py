...
from roboquant.ml.features import BarFeature, PositionPNLFeature
...
def run():
    ...
    model = RecurrentPPO("MlpLstmPolicy", env, verbose=1, tensorboard_log="./runs/")

    # Train the model
    model.learn(log_interval=10, total_timesteps=1_000_000)
