...
from roboquant.monetary import NoConversion, One2OneConversion, Wallet, Amount, USD, EUR, StaticConversion, JPY, GBP
...
class TestMonetary(unittest.TestCase):
    ...
    def test_static_conversion(self):
        now = datetime.now()
        Amount.converter = StaticConversion(USD, {EUR: 1.1, GBP: 1.3})
