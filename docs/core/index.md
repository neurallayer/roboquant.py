...
## The Run Loop
The core of the system is the [run()](run.md) function, which connects all components in a streaming event loop. At a high level, the run loop looks like this:
